        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <img src="{{asset('/img/DenahFTtdfgf.jpg')}}">
                </div>
        ...
        <div class="home-content-tablecell">
            <div class="row">
                <div class="col-twelve">
                    <h1 class="animate-intro"> Virtual Tour Amin Mohammad Foundation Ltd</h1>
                    <noscript>
                        <div id="warning"><strong>Branding and Communication<strong></div>
                    </noscript>
